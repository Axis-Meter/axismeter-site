        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          <div>
            ...
            <div className="flex gap-4 mt-6">
              <a href="https://www.instagram.com/axismetersolutions/" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="Instagram">
              ...
              <a href="https://www.facebook.com/profile.php?id=61559685498498" target="_blank" rel="noopener noreferrer" className="hover:text-accent transition-colors" aria-label="Facebook">
